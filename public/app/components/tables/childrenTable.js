...
export class ChildrenTableHeaderColumn extends React.Component {
    render() {
        return (
            <TableRow>
                <TableHeaderColumn tooltip="The ID">#</TableHeaderColumn>
                <TableHeaderColumn tooltip="The Name">Name</TableHeaderColumn>
                <TableHeaderColumn tooltip="The Children">Children</TableHeaderColumn>
...
export const ChildrenTableDataMap = tableData =>(
